...
<html lang="es">
    <head>
        ...
        <title>Sistema de inventario, registro de categoria</title>
    ...
    <body>
        ...
        <div class="container mt-4">
            ...
            <div class="d-flex">
                <a class="btn btn-outline-primary" href="Categoria?accion=listar">Listar</a>
            ...
            <table class="table">
                ...
                <tbody class="table-group-divider">
                    <c:forEach var = "registro" items="${registros}">
                        <tr>
                            <th scope="row">${registro.idCategoria}</th>
