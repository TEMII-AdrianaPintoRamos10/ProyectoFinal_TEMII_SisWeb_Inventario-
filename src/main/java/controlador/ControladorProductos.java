    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (accion) {
            ...
            case "Agregar":
                ...
                if (resultado != 0){
                    Categoria registro = new Categoria(nombre, descripcion, unidades, costo, precio, categoria, idUsuario, nombreUsuario, "Agregó");
                    CategoriaDAO DaoCategoria = new CategoriaDAO();
                    DaoCategoria.agregarRegistro(registro);
            ...
            case "Actualizar":
                ...
                if (respuesta != 0){
                    Categoria registroAnterior = new Categoria(productoAEditar.getNombre(), productoAEditar.getDescripcion(), productoAEditar.getUnidades(), productoAEditar.getCosto(), productoAEditar.getPrecio(), productoAEditar.getCategoria(), idUsuario, nombreUsuario, "Estado anterior");
                    CategoriaDAO DaoCategoria = new CategoriaDAO();
                    DaoCategoria.agregarRegistro(registroAnterior);
                    Categoria registro = new Categoria(nombre1, descripcion1, unidades1, costo1, precio1, categoria1, idUsuario, nombreUsuario, "Actualizó");
                    DaoCategoria.agregarRegistro(registro);
                    request.setAttribute("config", "alert alert-success");
            ...
            case "Delete":
                ...
                if (res != 0){
                    Categoria registro = new Categoria(productoABorrar.getNombre(), productoABorrar.getDescripcion(), productoABorrar.getUnidades(), productoABorrar.getCosto(), productoABorrar.getPrecio(), productoABorrar.getCategoria(), idUsuario, nombreUsuario, "Borró");
                    CategoriaDAO DaoCategoria = new CategoriaDAO();
                    DaoCategoria.agregarRegistro(registro);
